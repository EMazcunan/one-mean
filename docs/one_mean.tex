...
\item
  El \textbf{segundo cuartil} o \textbf{mediana} es el cuantil \(0.5\), o lo que es lo mismo, el valor que deja por debajo el \(50\%\) de los datos (y por arriba el otro \(50\%\)).
\item
...
\begin{center}\includegraphics[width=0.8\linewidth]{one_mean_files/figure-latex/unnamed-chunk-24-1} \end{center}
...
\begin{center}\includegraphics[width=0.8\linewidth]{one_mean_files/figure-latex/unnamed-chunk-26-1} \end{center}
...
\begin{center}\includegraphics[width=0.8\linewidth]{one_mean_files/figure-latex/unnamed-chunk-29-1} \end{center}
