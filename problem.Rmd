...
En el archivo enlazado a continuación se registran los radios de alcance de los  $100$ mandos analizados:  [mandos.csv](https://drive.google.com/uc?id=1dDOdobanG-_ZTTh0mx1R6KRSrnvtD8gL&export=download){target=_blank}. En el resto de la práctica se asume que el archivo `mandos.csv` está ubicado en un directorio de nombre `data` dentro del directorio en el que se encuentre el archivo `.Rmd` con el código.
